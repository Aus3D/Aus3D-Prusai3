...
#if (THERMISTORHEATER_0 == 70) || (THERMISTORHEATER_1 == 70) || (THERMISTORHEATER_2 == 70) || (THERMISTORBED == 70) 
// 100k thermistor (WITH 10kohm RESISTOR FOR PULLUP ON MELZI BOARD)
// Calculated using 10kohm pullup and 3 measured data points (25, 130 and 180 degrees C)
